    ...
    const projectElement = (<table className="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Centar</td>
          <td><button type="button" onClick={() => this.routeTo('/park/'+data[0])} className="btn btn-success">Choose</button></td>
        </tr>
        <tr>
          <th scope="row">{data[1]}</th>
          <td>Mladost 1</td>
          <td><button type="button" onClick={() => this.routeTo('/park/'+data[1])} className="btn btn-success">Choose</button></td>
        </tr>
        <tr>
          <th scope="row">{data[2]}</th>
          <td>Studentski Grad</td>
          <td><button type="button" onClick={() => this.routeTo('/park/'+data[2])} className="btn btn-success">Choose</button></td>
        </tr>
      </tbody>
    </table>);
